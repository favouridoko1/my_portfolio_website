...
const Main = () => {
  return (
    <section className="">
      <nav className="mx-auto text-[#fff] flex flex-col lg:flex-row items-center justify-around my-11 ">
        <section className="">
      ...
      >
        ...
        <p className="w-3/4 p-8 bg-[#816767] rounded-lg">
          About Me Hello! I’m [Your Name], a passionate frontend developer with
